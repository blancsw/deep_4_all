...
def translate_sentence(sentence, tokenizer, model, device, max_length=50):
    model.eval()
    ...
    for _ in range(max_length):
        ...
        if best_guess == TEXT.vocab.stoi["<eos>"]:
            break
...
model = ... # le modèle formé
device = ... # le dispositif sur lequel nous travaillons

output = translate_sentence(sentence, tokenize_fr, model, device)